        ...
        <v-col cols="8">
          ...
          <div class="d-flex justify-space-between">
            ...
            <div class="quantityUpdate d-flex">
              <span class="minus d-flex justify-center align-center m-pointer" @click="cartStore.remove(product.id)">-</span>
              <input class="text-center" type="text" :value="product.quantity" readonly>
              <span class="plus d-flex justify-center align-center " @click="cartStore.add(product.id)">+</span>
              <span class="delete d-flex justify-center align-center m-pointer"
                @click="cartStore.removeAll(product.id)"><i class="mdi-delete-outline mdi"></i>
              </span>
            </div>
          </div>
        </v-col>
