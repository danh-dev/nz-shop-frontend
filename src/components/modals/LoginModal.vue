...
<template>
	<!-- Begin : Login Modal  -->
	<v-btn color="#cd3545" class="text-white mt-2" @click="showLoginModal">Đánh giá ngay</v-btn>
	<div class="modal" ref="modal" @click="hideLoginModal" style="z-index: 2">
		<v-sheet rounded="lg" position="relative" class="modal-container" @click.stop>
			...
			<v-sheet color="#cd3545" class="modal-header py-1 d-flex align-center justify-center">
			...
			<v-sheet class="modal-body">
				...
				<v-btn href="#" class="mx-1 text-white" color="#cd3545" prepend-icon="mdi mdi-login">Đăng nhập</v-btn>
