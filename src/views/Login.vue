    ...
    >
      ...
      >
        <v-text-field
          ...
          density="compact"
          label="Email"
          :rules="[() => !!email || 'Vui lòng nhập email']"
        ...
        <div class="text-medium-emphasis d-flex align-center flex-row-reverse align-content-end">
          ...
          <router-link
            to="/forgot-password"
            class="text-caption text-decoration-none text-red-accent-4"
            tabindex="-1"
          >
            Quên mật khẩu?
          </router-link>
        ...
        <v-text-field
          ...
          :rules="[() => !!password || 'Vui lòng nhập mật khẩu']"
          autocomplete="off"
          density="compact"
          label="Mật khẩu"
      ...
      <v-card-text class="text-center">Chưa có tài khoản?
        <router-link
          to="/register"
          class="text-blue text-decoration-none m-pointer"
        >
          Đăng ký ngay
        </router-link>
      </v-card-text>
