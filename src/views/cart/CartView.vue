...
<template>
  <v-app>
    <v-container>
        ...
        <v-row class="ma-3" no-gutters>
          ...
          <v-col cols="4" class="rounded pa-3">
            ...
            <v-card class="my-2 pa-3">
              ...
              <v-btn block="" variant="flat" size="large" class="w-75 bg-red-darken-2">
                Tiến hành đặt hàng
              </v-btn>
            </v-card>
          </v-col>
      ...
      <v-sheet v-else class="rounded pa-3 d-flex flex-column justify-center align-center" elevation="3">
        <div> <v-lazy>
            <iframe width="300" height="300" frameBorder="0"
              src="https://lottie.host/?file=95af846f-f62b-4bc5-b422-26c7cabda6eb/65kwV7npxO.json"></iframe></v-lazy>
        </div>
        <div class="ma-3">
