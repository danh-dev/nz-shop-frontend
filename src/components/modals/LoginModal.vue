	...
	>
		...
		>
			...
			<v-sheet
				color="red-accent-4"
				rounded="lg"
				class="modal-header py-1 d-flex align-center justify-center"
			>
				<v-icon
					size="small"
					color="white"
...
>
	<v-sheet
		position="relative"
		class="reviewModal-container"
		@click.stop
	>

		<v-sheet
			rounded="lg"
			class="py-1 d-flex flex-column align-center justify-center text-body"
		>
			<img
